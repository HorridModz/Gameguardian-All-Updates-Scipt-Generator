...
command = 'pyinstaller cli/cli.py --additional-hooks-dir="../pyinstaller hooks"' \
          ...
          ' --distpath "../dist" --name "all_updates_generator" -y'
print(command)
subprocess.run(command)
# Add loggingconfig.py file to build directory
copyfile("resources/loggingconfig.json", "../dist/all_updates_generator/loggingconfig.json")
