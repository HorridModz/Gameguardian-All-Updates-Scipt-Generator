...
title = Gameguardian All Updates Script Generator

# (str) Package name
package.name = allupdatesgenerator

# (str) Package domain (needed for android/ios packaging)
package.domain = com.github.horridmodz

# (str) Source code where the main.py live
source.dir = ../
# Main file is app.py, which is adjacent to this one
source.main = ./app.py
...
source.include_patterns = %(source.dir)s/Android/loggingconfig.json,%(source.dir)s/resources/**
...
# Read version from file src\cli.py
version.regex = __version__ = ['"](.*)['"]
version.filename = %(source.dir)s/cli.py

# (list) Application requirements
# comma separated e.g. requirements = sqlite3,kivy
requirements = python3,kivy,capstone,keystone-engine,pyelftools,colorama,docopt,schema
...
presplash.filename = %(source.dir)s/resources/horridlogo.png

# (str) Icon of the application
icon.filename = %(source.dir)s/resources/horridlogo.png
